...
$orderService = new ActiveOrderService();
...
<!--                    <a class="remove-order" href="--><?php //= $route->route('order_remove', ['orderId' => $order['ID']]) ?><!--">Заказ выполнен</a>-->
                    <button  class="remove-order" data-order-id="<?= $order['ID'] ?>">Заказ выполнен</button>
                </div>
            <?php endforeach; ?>
        <?php endif; ?>
    </div>
